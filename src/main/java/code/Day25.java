...
public class Day25 {
    ...
    public static void main(String[] args) {
        ...
        for(String line : lines){
            ...
            graph.addVertex(v);
            String part2 = line.split(":")[1].trim();
        ...
        // Find the minimum cut using Stoer Wagner MinimumCut
        StoerWagnerMinimumCut<String, DefaultEdge> stoerWagnerMinimumCut =
                new StoerWagnerMinimumCut<>(graph);

        Set<String> minCut = stoerWagnerMinimumCut.minCut();

        // Calculate the number of vertices on both disjoint sets
        int verticesInSet1 = minCut.size();
        int verticesInSet2 = graph.vertexSet().size() - verticesInSet1;

        // Print the result
        System.out.println("Result of multiplication of size of two disjoint sets : " + verticesInSet1 * verticesInSet2);
    }
}
